...
\`\`\`
safealert-platform/
├── sistema-unificado/ # Puerto 3000 - Dashboard principal
├── modulo-inventario/ # Puerto 3001 - Gestión de inventario
├── modulo-recetas/ # Puerto 3002 - Recetas con IA
└── modulo-alertas/ # Puerto 3003 - Alertas y reportes
\`\`\`
...
3. Obtener credenciales (URL, anon key, service role key)
...
\`\`\`env
POSTGRES_HOST=db.tu_proyecto.supabase.co
...
2. Verificar que los 3 módulos aparezcan como "En línea"
3. Probar funcionalidades básicas en cada módulo
...
1. **Base de datos compartida** (Supabase/PostgreSQL)
2. **APIs RESTful** para intercambio de datos
3. **Dashboard unificado** para navegación
4. **Eventos y notificaciones** entre sistemas
